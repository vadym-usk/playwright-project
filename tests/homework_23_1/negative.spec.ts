...
test.describe('Negative Tests', () => {
    ...
    test.skip('Check registration popup with empty fields', async ({ }) => {
    ...
    test.skip('Check registration popup with wrong data', async ({ }) => {
        await homePage.clickSignUpBtn();
    ...
    test.skip('Check registration popup with wrong length for Name, Last Name and Password fields', async ({ }) => {
        await homePage.clickSignUpBtn();
    ...
    test.skip('Check registration popup with special symbols for Password field', async ({ }) => {
        await homePage.clickSignUpBtn();
    ...
    test.skip('Check registration popup with not matched passwords', async ({ }) => {
        await homePage.clickSignUpBtn();
